...
class SolicitacaoReembolso:
    ...
    def Solicitacao_Reembolso_Juridico_Function(perfil, unityY):
        with connections['auth_finances'].cursor() as cursor:
            Q = fetchAdministrator("unit.unity", perfil, unityY)
